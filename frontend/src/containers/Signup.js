...
const Signup = () => {
    ...
    const handleChange = (e) => {
        ...
        else if (e.target.name === 'Given Name') {setGivenName(e.target.value)}
        else if (e.target.name === 'Surname') {setSurname(e.target.value)}
    ...
    return (
        <main className='h-screen'>
            ...
            <section className='h-screen flex flex-col justify-center items-center gap-5'>
                ...
                <form onSubmit={handleSubmit} className='z-10 bg-green-600 flex flex-wrap flex-col mx-auto space-y-4 p-5 rounded-xl'>
                    <TextField value={username} name='Username' onChange={handleChange} placeholder='Username' />
                    <TextField value={givenName} name='Given Name' onChange={handleChange} placeholder='Given Name' />
                    <TextField value={surname} name='Surname' onChange={handleChange} placeholder='Surname' />
                    <TextField value={email} name='Email' onChange={handleChange} placeholder='Email' />
                    <TextField value={password} name='Password' onChange={handleChange} password  placeholder='Password' />
                    <button 
                        type='submit' 
